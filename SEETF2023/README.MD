...
- Làm cho độ dài khi query nhỏ hơn 2MB sao cho khi điều hướng đến ?found=0 với phần fragment sẽ vừa đủ (hoặc lớn hơn 1 ít vì `q=` và `found=0` chỉ đủ search 4 ký tự thôi)2MB và gây ra `about:blank#block`
